...
requirements = python3==3.11.9,hostpython3==3.11.9,aiohttp,aiosignal,attrs,multidict,yarl,frozenlist,async-timeout,charset-normalizer,idna,certifi,protobuf,pyee,requests,websocket-client,betterproto,betterproto2==0.9.0,TikTokLive,TikTokLiveProto,EulerApiSdk==0.1.1,httpx,httpcore,h11,anyio,sniffio,protobuf3-to-dict,websockets,ffmpy,mashumaro,typing-extensions,pyjnius,pydantic==2.12.2,pydantic-core==2.41.4,annotated-types,typing-inspection

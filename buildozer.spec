...
requirements = python3==3.11.9,hostpython3==3.11.9,aiohttp,httpx,httpcore,h11,anyio,sniffio,certifi,idna,charset-normalizer,attrs,aiosignal,multidict,yarl,frozenlist,async-timeout,pyee,ffmpy,websockets,websockets_proxy==0.1.3,betterproto==2.0.0b7,mashumaro,protobuf,protobuf3-to-dict,typing-extensions,TikTokLive=="6.5.3",pyjnius,requests,websocket-client,python-socks,EulerApiSdk=="0.0.3"
